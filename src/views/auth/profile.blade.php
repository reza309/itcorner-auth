                    ...
                    <ul class="list-group-flush">
                        <li class="list-group-item">
                            <form action="{{route('profileUpload')}}" method="POST" enctype="multipart/form-data" id="profile-upload-form">
                                @csrf
                                <img src="{{empty($user[0]->images)?asset('auth-image/avater.png'):$user[0]->images}}" alt="" srcset="" class="img img-fluid rounded rounded-circle border" style="width:50px height:50px">
                                <div class="d-flex">
                                    <div class="mb-3">
                            ...
                            <div class="pt-lg-3">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 pe-3">
                                        <input type="submit" value="Save Profile" class="btn btn-primary w-100 me-3">
                                    </div>
                                </div>
                            </div>
                        </form>
